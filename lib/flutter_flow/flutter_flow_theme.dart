...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF35D4B7);
  late Color secondary = const Color(0xFF08A488);
  late Color tertiary = const Color(0xFF95FFEC);
  late Color alternate = const Color(0xFFBF0C0C);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF525252);
  late Color primaryBackground = const Color(0xFFBFBDBD);
